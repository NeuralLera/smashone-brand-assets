...
| Герой | Роль | Референс |
|---|---|---|
| Sloane (Слоан) | SMM-менеджер | `sloane/reference/sloane-art-reference-v1.jpeg` (896×1200) |
...
sage-art-v2 (+ art-profile-v2) · sloane-art-v1. 🔴 **Слоан снималась с РИСУНКА** — это факт, а не
опечатка: её фильм принят, но её фотомастер ещё не снят.
